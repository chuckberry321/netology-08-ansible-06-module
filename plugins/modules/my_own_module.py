...
description: This module will create text file on the remote host
...
options:
    name:
        ...
        type: str
    new:
        description: Check result module work
        required: false
        type: bool
...
def run_module():
    ...
    module_args = dict(
        ...
        content=dict(type='str', required=False, default="Some text")
    )
